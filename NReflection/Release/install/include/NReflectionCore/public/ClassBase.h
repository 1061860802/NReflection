...
namespace NLEngine
{
	...
	public:
		...
		std::map<std::string,CMemberVariableBase*> MemberVariableMap_;
		std::map<std::string,CStaticVariableBase*> StaticVariableMap_;
		std::map<std::string, CMemberFunctionContainerBase*> MemberFuncMap_;
		std::map<std::string, CStaticFunctionContainerBase*> StaticFuncMap_;
	};
