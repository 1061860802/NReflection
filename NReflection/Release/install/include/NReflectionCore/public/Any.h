...
namespace NLEngine
{
	struct CAny_
	{
		CAny_(const TVariableTypeContainer<CType>& IN_Type) :Type_(IN_Type) {};
		virtual ~CAny_() {};
		const TVariableTypeContainer<CType>& GetType() const
		{
			return Type_;
		}
	...
	{
		CAnyRef_(const TVariableTypeContainer<CType>& RefType, const TVariableTypeContainer<CType>& CType) :RefType_(RefType), CAny_(CType) {};
		virtual ~CAnyRef_() {};
		const TVariableTypeContainer<CType>& GetRefType() const
		{
			return RefType_;
		}
		...
		const TVariableTypeContainer<CType> RefType_;
	};
	...
	struct TAnyRef_ : public CAnyRef_
	{
		...
		TAnyRef_(Type_T&& Val, const TVariableTypeContainer<CType>& RefType, const TVariableTypeContainer<CType>& CType) :CAnyRef_(RefType, CType), Value(std::forward<Type_T>(Val)) {};
		virtual ~TAnyRef_()
		{
			CAnyRef_::~CAnyRef_();
		};
	...
	{
		using Type_T = typename T;
		TAny_(const T& Val, const TVariableTypeContainer<CType>& CType) :CAny_(CType), Value(Val) {};
		virtual ~TAny_()
		{
			CAny_::~CAny_();
		};
	...
	{
		using Type_T = void;
		TAny_(const TVariableTypeContainer<CType>& CType) :CAny_(CType) {};
		virtual ~TAny_()
		{
			CAny_::~CAny_();
		};
	...
	struct CAny
	{
		...
		const TVariableTypeContainer<CType> GetValType() const
		{
			if (Val_)
			{
				return Val_->GetType();
