...
{
public:
	CMemberFunctionBase(const TVariable_Type_Container<CType>& OwnerClass,const TVariable_Type_Container<CType>& Result, std::vector<TVariable_Type_Container<CType>> Params,const std::string& Name,const std::string& RealName, const type_info& type_info_) :
	...
	const TVariable_Type_Container<CType>& GetTargetClass() const { return OwnerClass_; };
...
protected:
	const TVariable_Type_Container<CType> OwnerClass_;
...
{
public:
	TMemberFunction(const TVariable_Type_Container<CType>& OwnerClass, const TVariable_Type_Container<CType>& Result, std::vector<TVariable_Type_Container<CType>> Params) :
...
public:
	...
	TMemberFuncFactory()
	{
		info_ = GetTypeManager().GetOrRegistor<TMemberFunction<Ret, TClass, Params...>>(TVariable_Type_Container<CType>(GetType<ClassT>(), ClassConst), TVariable_Type_Container<CType>(GetType<RetT>(), RetConst), GetParams());
	};
